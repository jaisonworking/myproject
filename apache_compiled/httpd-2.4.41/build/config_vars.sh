...
if test -f ${DESTDIR}/TK/apache/httpd/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/TK/apache/httpd/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/TK/apache/httpd/bin/apu-1-config
else
...
test -n "/TK/apache/httpd/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/TK/apache/httpd/build"
